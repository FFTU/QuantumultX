...
!(async () => {
  ...
  .catch((e) => senku.log(`❌ ${cookieName} 签到失败: ${e}`))
  .finally(() => $.done())
...
function playone () {
  return new Promise((resolve, reject) => {
    const urlParameter = 'https://api.1sapp.com/sign/adDone?&xhi=200&pos=one' + signVal
    const url = {
      url: urlParameter,
      headers: {
        'Host': 'api.1sapp.com',
...
function playtwo () {
  return new Promise((resolve, reject) => {
    const urlParameter = 'https://api.1sapp.com/sign/adDone?&xhi=200&pos=two' + signVal
    const url = {
      url: urlParameter,
      headers: {
        'Host': 'api.1sapp.com',
...
function playthree () {
  return new Promise((resolve, reject) => {
    const urlParameter = 'https://api.1sapp.com/sign/adDone?&xhi=200&pos=three' + signVal
    const url = {
      url: urlParameter,
      headers: {
        'Host': 'api.1sapp.com',
...
function playfour () {
  return new Promise((resolve, reject) => {
    const urlParameter = 'https://api.1sapp.com/sign/adDone?&xhi=200&pos=four' + signVal
    const url = {
      url: urlParameter,
      headers: {
        'Host': 'api.1sapp.com',
